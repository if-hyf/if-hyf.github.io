...
.edu-left{ width:90px; font-weight:700; font-size:20px; line-height:1.2; white-space:nowrap; }
.edu-mid{ flex:1; min-width:0; }
.edu-date{ font-size:18px; font-weight:600; margin-bottom:4px; }
.edu-text{ font-size:16px; line-height:1.6; margin:0; }
...
@media (max-width: 700px){
  ...
  .edu-right{ width:auto; justify-content:flex-start; }
  .edu-logo{ width:72px; }
}
</style>

<div class="edu-row">
  <div class="edu-left">M.S.</div>
